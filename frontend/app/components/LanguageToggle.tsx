...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  ml: {
    subtitle: 'ICU മുൻകൂർ മുന്നറിയിപ്പ് സംവിധാനം — ML അധിഷ്ഠിതം',
    live: 'സജീവം', patients: 'രോഗികൾ', predictRisk: 'അപകടസാധ്യത പ്രവചിക്കുക',
    predicting: 'വിശകലനം നടക്കുന്നു...', backendLive: 'സെർവർ സജീവം',
    pinging: 'ബന്ധിപ്പിക്കുന്നു...', reconnecting: 'വീണ്ടും ബന്ധിപ്പിക്കുന്നു',
    disclaimer: '⚠️ ഡെമോ മാത്രം — BioSignal MIMIC-IV ഡാറ്റയിൽ പരിശീലനം നേടിയതാണ്. വൈദ്യ തീരുമാനങ്ങൾക്ക് ഉപയോഗിക്കരുത്.',
    clickPredict: 'ക്ലിക്ക് ചെയ്യുക', toRunML: 'ML വിശകലനം പ്രവർത്തിപ്പിക്കാൻ',
    lightgbm: 'SHAP വ്യാഖ്യാനത്തോടുകൂടിയ LightGBM മോഡൽ',
    tab_dashboard: 'ML ഡാഷ്‌ബോർഡ്', tab_analyzer: 'റിപ്പോർട്ട് വിശകലകൻ',
    tab_heatmap: 'ഹീറ്റ്മാപ്പ്', tab_timeline: 'ടൈംലൈൻ',
    tab_fluid: 'ദ്രവ സന്തുലനം', tab_shift: 'ഷിഫ്റ്റ് റിപ്പോർട്ട്',
    tab_model: 'മോഡൽ സ്ഥിതിവിവരക്കണക്കുകൾ', tab_export: 'കയറ്റുമതി',
    tab_sepsis: 'Sepsis', tab_apache: 'APACHE II',
