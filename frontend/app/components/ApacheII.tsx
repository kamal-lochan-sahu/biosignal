...
export default function ApacheII() {
  const [vals, setVals] = useState<ApacheVals>({
    temp: 37.5, map: 85, heart_rate: 88, resp_rate: 18,
    fio2: 0.21, pao2: 95, ph: 7.38, sodium: 138,
    potassium: 4.0, creatinine: 1.1, hematocrit: 38,
    wbc: 9, gcs: 15, age: 60, chronic: 0
  })
